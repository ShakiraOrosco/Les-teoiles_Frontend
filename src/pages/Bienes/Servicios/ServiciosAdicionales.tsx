...
// Excel y PDF (ya no necesitas XLSX)
import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";

// MOCK DATA
const MOCK_SERVICIOS: ServicioAdicional[] = [
    { id_servicios_adicionales: 1, nombre: "Limpieza Premium", descripcion: "Servicio completo", precio: 150.0, estado: "A" },
    { id_servicios_adicionales: 2, nombre: "Mantenimiento Express", descripcion: "Revisión rápida", precio: 250.5, estado: "A" },
    { id_servicios_adicionales: 3, nombre: "Cambio de Aceite", descripcion: "Aceite sintético", precio: 180.0, estado: "A" },
    { id_servicios_adicionales: 4, nombre: "Lavado Simple", descripcion: "Lavado exterior", precio: 50.0, estado: "I" },
    { id_servicios_adicionales: 5, nombre: "Pulido de Carrocería", descripcion: "Pulido profesional", precio: 350.0, estado: "A" },
    { id_servicios_adicionales: 6, nombre: "Inspección Técnica", descripcion: "Revisión completa", precio: 200.0, estado: "A" },
    { id_servicios_adicionales: 7, nombre: "Cambio de Llantas", descripcion: "Instalación de neumáticos", precio: 100.0, estado: "I" },
    { id_servicios_adicionales: 8, nombre: "Alineación y Balanceo", descripcion: "Alineación computarizada", precio: 120.0, estado: "A" },
];
...
export default function ServiciosAdicionalesPage() {
    ...
    const [estado, setEstado] = useState<"" | "E" | "A" | "X" | "I">("");
    ...
    const serviciosFiltrados = servicios.filter((servicio) => {
        const matchesFiltro = `${servicio.nombre} ${servicio.descripcion || ""}`.toLowerCase().includes(filtro.toLowerCase());
...
const handleExportExcel = () => {
    // Definir colores suaves y verdes
    const colors = {
        verdeOscuro: '#0E7C7B',      // Dark cyan verde
        verdeMedio: '#2A9D8F',       // Verde medio suave
        verdeClaro: '#99D8CD',       // Tiffany blue (verde claro)
        verdeMenta: '#E8F4F2',       // Verde menta muy claro
        blanco: '#FFFFFF',
        coralSuave: '#FF9B8A',       // Coral suave
        grisClaro: '#F8F9FA',        // Gris muy claro
        grisMedio: '#E9ECEF'         // Gris medio para bordes
    };

    // Crear HTML con estilos mejorados
    const htmlTable = `
        ...
        <head>
            ...
            <style>
                ...
                /* Filas alternas con verde muy suave */
...
const handleExportPDF = () => {
    ...
    // Paleta de colores verdes suaves
    const colors = {
    ...
    autoTable(doc, {
        head: [['N°', 'Nombre del Servicio', 'Descripción', 'Precio', 'Estado']],
        body: tableData,
        startY: startY + 25,
        theme: 'grid',
        styles: {
    ...
    return (
        <div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12 space-y-6">
                ...
                {/* Filtros y acciones */}
                <ServiciosFilter filtro={filtro} setFiltro={setFiltro} estado={estado} setEstado={setEstado}>
