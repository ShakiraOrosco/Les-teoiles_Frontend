...
import { Home, ChevronLeft, ChevronRight, X, Upload, Copy, Check, AlertCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-teal-50 p-6 flex items-center justify-center">
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">Por favor espera mientras verificamos los requisitos y disponibilidad de habitaciones</p>
