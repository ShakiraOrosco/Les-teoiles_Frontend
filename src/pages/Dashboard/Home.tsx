...
export default function Home() {
  ...
  const getAccionColor = (accion: string) => {
    const colores: { [key: string]: string } = {
      ...
      'REGISTRO INGRESO': 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300',
      'REGISTRO SALIDA': 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
    };
