...
import { useUploadComprobante } from "../../../../hooks/AdReservas/Reserva_Hospedaje/useUploadComprobante";
import { useObtenerTarifa } from "../../../../hooks/AdReservas/Reserva_Hospedaje/useObtenerTarifa";
import {
...
export default function HospedajeModal({ isOpen, onClose, onSuccess }: HospedajeModalProps) {
  ...
  const { subirComprobante, loading: isUploadingComprobante, error: uploadError } = useUploadComprobante();
  const { obtenerPrecioPorPersona, loading: isLoadingTarifas } = useObtenerTarifa();
        ...
        <div className="mt-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              >
                {loading ? 'Enviando...' : montoTotal === 0 ? 'Complete el formulario' : 'Enviar Solicitud'}
              </Button>
            </div>
          </form>
        </div>
